    ...
    public static class Persistence {
        public static void init() {
            try {
                ...
                PreparedStatement statement = DatabaseConnection.getCon().prepareStatement(createSQLTable);
        ...
        public static int register(String username, String password) {
            ...
            try {
                ...
                PreparedStatement statement = DatabaseConnection.getCon().prepareStatement(insertSQL);
        ...
        public static Account authenticate(String username, String password) throws AuthenticationException {
            try {
                ...
                PreparedStatement statement = DatabaseConnection.getCon().prepareStatement(sql);
                statement.setString(1, username);
